...
int myosd_droid_netplay_plugins_allowed(void);     // handshake verdict: both opted in, not a drop-in game
int myosd_droid_netplay_plugins_pref(void);        // this device's own plugin opt-in (handshake input)
